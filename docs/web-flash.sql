/*
 ...
 Source Schema         : web-flash

 Target Server Type    : MySQL
 Target Server Version : 50711
 File Encoding         : 65001

 Date: 23/03/2020 15:12:08
*/
...
CREATE TABLE `t_cms_banner`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'Banner' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `t_sys_cfg` VALUES (1, NULL, NULL, -1, '2020-03-23 15:00:00', 'update by 2020-03-23 15:00:00', 'system.app.name', 'web-flash');
...
CREATE TABLE `t_sys_link`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 78 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '连接' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_sys_link
-- ----------------------------
INSERT INTO `t_sys_link` VALUES (76, 1, '2020-03-23 15:07:46', 1, '2020-03-23 15:07:46', 'teerer', 'asdasdasd');
INSERT INTO `t_sys_link` VALUES (77, 1, '2020-03-23 15:08:01', 1, '2020-03-23 15:08:01', 'asdasda', 'asdasdf');
...
CREATE TABLE `t_sys_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 81 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录日志' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_sys_login_log` VALUES (73, '2020-03-23 14:07:30', '127.0.0.1', '登录日志', NULL, '成功', 1);
INSERT INTO `t_sys_login_log` VALUES (74, '2020-03-23 14:26:11', '127.0.0.1', '登录日志', NULL, '成功', 1);
INSERT INTO `t_sys_login_log` VALUES (75, '2020-03-23 14:26:18', '127.0.0.1', '登录日志', NULL, '成功', 1);
INSERT INTO `t_sys_login_log` VALUES (76, '2020-03-23 14:28:32', '127.0.0.1', '登录日志', NULL, '成功', 1);
INSERT INTO `t_sys_login_log` VALUES (77, '2020-03-23 14:32:46', '127.0.0.1', '登录日志', NULL, '成功', 1);
INSERT INTO `t_sys_login_log` VALUES (78, '2020-03-23 14:34:02', '127.0.0.1', '登录日志', NULL, '成功', 1);
INSERT INTO `t_sys_login_log` VALUES (79, '2020-03-23 15:04:44', '127.0.0.1', '登录日志', NULL, '成功', 1);
INSERT INTO `t_sys_login_log` VALUES (80, '2020-03-23 15:10:43', '127.0.0.1', '登录日志', NULL, '成功', 3);
...
CREATE TABLE `t_sys_menu`  (
  ...
  `isopen` int(11) NULL DEFAULT NULL COMMENT '是否默认打开1:是,0:否',
...
) ENGINE = InnoDB AUTO_INCREMENT = 76 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_sys_menu` VALUES (71, 1, '2020-03-23 13:27:05', 1, '2020-03-23 13:27:05', 'link', 'views/system/link/index', 0, 'dict', 1, NULL, 2, '连接管理', 4, 'system', '[0],[system],', 1, NULL, '/link');
INSERT INTO `t_sys_menu` VALUES (72, 1, '2020-03-23 14:22:39', 1, '2020-03-23 14:22:39', 'linkAdd', NULL, 0, NULL, 0, NULL, 3, '添加连接', 1, 'link', '[0],[system],[link],', 1, NULL, '/link/add');
INSERT INTO `t_sys_menu` VALUES (74, 1, '2020-03-23 14:24:25', 1, '2020-03-23 14:24:25', 'linkDelete', NULL, 0, NULL, 0, NULL, 3, '删除连接', 1, 'link', '[0],[system],[link],', 1, NULL, '/link/delete');
INSERT INTO `t_sys_menu` VALUES (75, 1, '2020-03-23 14:48:38', 1, '2020-03-23 14:48:38', 'linkEdit', NULL, 0, NULL, 0, NULL, 3, '修改连接', 1, 'link', '[0],[system],[link],', 1, NULL, '/link/update');
...
CREATE TABLE `t_sys_operation_log`  (
  ...
  `userid` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_sys_operation_log` VALUES (5, 'cn.enilu.flash.api.controller.system.MenuController', '2020-03-23 13:27:05', '编辑菜单', '业务日志', '菜单名称=连接管理;;;', 'save', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (6, 'cn.enilu.flash.api.controller.system.RoleController', '2020-03-23 13:27:27', '配置角色权限', '业务日志', '角色名称=超级管理员', 'setAuthority', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (7, 'cn.enilu.flash.api.controller.system.MenuController', '2020-03-23 14:22:39', '编辑菜单', '业务日志', '菜单名称=添加连接;;;', 'save', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (8, 'cn.enilu.flash.api.controller.system.MenuController', '2020-03-23 14:23:48', '编辑菜单', '业务日志', '菜单名称=修改连接;;;', 'save', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (9, 'cn.enilu.flash.api.controller.system.MenuController', '2020-03-23 14:24:25', '编辑菜单', '业务日志', '菜单名称=删除连接;;;', 'save', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (10, 'cn.enilu.flash.api.controller.system.MenuController', '2020-03-23 14:25:08', '编辑菜单', '业务日志', '菜单名称=修改连接;;;', 'save', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (11, 'cn.enilu.flash.api.controller.system.RoleController', '2020-03-23 14:26:01', '配置角色权限', '业务日志', '角色名称=超级管理员', 'setAuthority', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (12, 'cn.enilu.flash.api.controller.system.RoleController', '2020-03-23 14:28:29', '配置角色权限', '业务日志', '角色名称=超级管理员', 'setAuthority', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (13, 'cn.enilu.flash.api.controller.system.MenuController', '2020-03-23 14:32:07', '编辑菜单', '业务日志', '菜单名称=修改连接;;;', 'save', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (14, 'cn.enilu.flash.api.controller.system.MenuController', '2020-03-23 14:33:11', '编辑菜单', '业务日志', '菜单名称=修改连接;;;', 'save', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (15, 'cn.enilu.flash.api.controller.system.RoleController', '2020-03-23 14:33:51', '配置角色权限', '业务日志', '角色名称=超级管理员', 'setAuthority', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (16, 'cn.enilu.flash.api.controller.system.RoleController', '2020-03-23 14:33:57', '配置角色权限', '业务日志', '角色名称=超级管理员', 'setAuthority', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (17, 'cn.enilu.flash.api.controller.system.MenuController', '2020-03-23 14:34:36', '删除菜单', '业务日志', '菜单id=73', 'remove', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (18, 'cn.enilu.flash.api.controller.system.RoleController', '2020-03-23 14:34:48', '配置角色权限', '业务日志', '角色名称=超级管理员', 'setAuthority', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (19, 'cn.enilu.flash.api.controller.system.LinkController', '2020-03-23 14:35:02', '删除连接', '业务日志', '主键id=71', 'delete', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (20, 'cn.enilu.flash.api.controller.system.LinkController', '2020-03-23 14:47:02', '添加连接', '业务日志', 'null=TEST', 'add', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (21, 'cn.enilu.flash.api.controller.system.MenuController', '2020-03-23 14:48:38', '编辑菜单', '业务日志', '菜单名称=修改连接;;;', 'save', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (22, 'cn.enilu.flash.api.controller.system.RoleController', '2020-03-23 14:48:57', '配置角色权限', '业务日志', '角色名称=超级管理员', 'setAuthority', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (23, 'cn.enilu.flash.api.controller.system.LinkController', '2020-03-23 14:52:14', '删除连接', '业务日志', '主键id=72', 'delete', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (24, 'cn.enilu.flash.api.controller.system.LinkController', '2020-03-23 14:52:40', '添加连接', '业务日志', 'null=test', 'add', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (25, 'cn.enilu.flash.api.controller.system.LinkController', '2020-03-23 14:59:40', '删除连接', '业务日志', '主键id=73', 'delete', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (26, 'cn.enilu.flash.api.controller.system.LinkController', '2020-03-23 14:59:46', '添加连接', '业务日志', 'null=teerer', 'add', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (27, 'cn.enilu.flash.api.controller.system.LinkController', '2020-03-23 15:00:53', '添加连接', '业务日志', 'null=asdasda', 'add', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (28, 'cn.enilu.flash.api.controller.system.LinkController', '2020-03-23 15:07:46', '修改连接', '业务日志', 'null=teerer;;;', 'update', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (29, 'cn.enilu.flash.api.controller.system.LinkController', '2020-03-23 15:08:01', '修改连接', '业务日志', 'null=asdasda;;;', 'update', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (30, 'cn.enilu.flash.api.controller.system.RoleController', '2020-03-23 15:09:42', '编辑角色', '业务日志', '角色名称=业务;;;', 'save', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (31, 'cn.enilu.flash.api.controller.system.UserController', '2020-03-23 15:10:15', '编辑账号', '业务日志', '名字=worker;;;', 'save', '成功', 1);
INSERT INTO `t_sys_operation_log` VALUES (32, 'cn.enilu.flash.api.controller.system.UserController', '2020-03-23 15:10:24', '设置账号角色', '业务日志', '账号=worker', 'setRole', '成功', 1);
...
CREATE TABLE `t_sys_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 654 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单角色关系' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_sys_relation` VALUES (580, 1, 1);
INSERT INTO `t_sys_relation` VALUES (581, 4, 1);
INSERT INTO `t_sys_relation` VALUES (582, 5, 1);
INSERT INTO `t_sys_relation` VALUES (583, 6, 1);
INSERT INTO `t_sys_relation` VALUES (584, 7, 1);
INSERT INTO `t_sys_relation` VALUES (585, 8, 1);
INSERT INTO `t_sys_relation` VALUES (586, 9, 1);
INSERT INTO `t_sys_relation` VALUES (587, 10, 1);
INSERT INTO `t_sys_relation` VALUES (588, 11, 1);
INSERT INTO `t_sys_relation` VALUES (589, 12, 1);
INSERT INTO `t_sys_relation` VALUES (590, 13, 1);
INSERT INTO `t_sys_relation` VALUES (591, 14, 1);
INSERT INTO `t_sys_relation` VALUES (592, 15, 1);
INSERT INTO `t_sys_relation` VALUES (593, 16, 1);
INSERT INTO `t_sys_relation` VALUES (594, 17, 1);
INSERT INTO `t_sys_relation` VALUES (595, 18, 1);
INSERT INTO `t_sys_relation` VALUES (596, 19, 1);
INSERT INTO `t_sys_relation` VALUES (597, 20, 1);
INSERT INTO `t_sys_relation` VALUES (598, 21, 1);
INSERT INTO `t_sys_relation` VALUES (599, 23, 1);
INSERT INTO `t_sys_relation` VALUES (600, 24, 1);
INSERT INTO `t_sys_relation` VALUES (601, 28, 1);
INSERT INTO `t_sys_relation` VALUES (602, 29, 1);
INSERT INTO `t_sys_relation` VALUES (603, 32, 1);
INSERT INTO `t_sys_relation` VALUES (604, 22, 1);
INSERT INTO `t_sys_relation` VALUES (605, 25, 1);
INSERT INTO `t_sys_relation` VALUES (606, 26, 1);
INSERT INTO `t_sys_relation` VALUES (607, 27, 1);
INSERT INTO `t_sys_relation` VALUES (608, 30, 1);
INSERT INTO `t_sys_relation` VALUES (609, 31, 1);
INSERT INTO `t_sys_relation` VALUES (610, 33, 1);
INSERT INTO `t_sys_relation` VALUES (611, 34, 1);
INSERT INTO `t_sys_relation` VALUES (612, 35, 1);
INSERT INTO `t_sys_relation` VALUES (613, 36, 1);
INSERT INTO `t_sys_relation` VALUES (614, 37, 1);
INSERT INTO `t_sys_relation` VALUES (615, 38, 1);
INSERT INTO `t_sys_relation` VALUES (616, 39, 1);
INSERT INTO `t_sys_relation` VALUES (617, 40, 1);
INSERT INTO `t_sys_relation` VALUES (618, 47, 1);
INSERT INTO `t_sys_relation` VALUES (619, 71, 1);
INSERT INTO `t_sys_relation` VALUES (620, 72, 1);
INSERT INTO `t_sys_relation` VALUES (621, 74, 1);
INSERT INTO `t_sys_relation` VALUES (622, 75, 1);
INSERT INTO `t_sys_relation` VALUES (623, 2, 1);
INSERT INTO `t_sys_relation` VALUES (624, 41, 1);
INSERT INTO `t_sys_relation` VALUES (625, 68, 1);
INSERT INTO `t_sys_relation` VALUES (626, 69, 1);
INSERT INTO `t_sys_relation` VALUES (627, 42, 1);
INSERT INTO `t_sys_relation` VALUES (628, 70, 1);
INSERT INTO `t_sys_relation` VALUES (629, 43, 1);
INSERT INTO `t_sys_relation` VALUES (630, 66, 1);
INSERT INTO `t_sys_relation` VALUES (631, 67, 1);
INSERT INTO `t_sys_relation` VALUES (632, 44, 1);
INSERT INTO `t_sys_relation` VALUES (633, 45, 1);
INSERT INTO `t_sys_relation` VALUES (634, 65, 1);
INSERT INTO `t_sys_relation` VALUES (635, 46, 1);
INSERT INTO `t_sys_relation` VALUES (636, 3, 1);
INSERT INTO `t_sys_relation` VALUES (637, 48, 1);
INSERT INTO `t_sys_relation` VALUES (638, 50, 1);
INSERT INTO `t_sys_relation` VALUES (639, 51, 1);
INSERT INTO `t_sys_relation` VALUES (640, 49, 1);
INSERT INTO `t_sys_relation` VALUES (641, 52, 1);
INSERT INTO `t_sys_relation` VALUES (642, 53, 1);
INSERT INTO `t_sys_relation` VALUES (643, 54, 1);
INSERT INTO `t_sys_relation` VALUES (644, 55, 1);
INSERT INTO `t_sys_relation` VALUES (645, 56, 1);
INSERT INTO `t_sys_relation` VALUES (646, 57, 1);
INSERT INTO `t_sys_relation` VALUES (647, 58, 1);
INSERT INTO `t_sys_relation` VALUES (648, 61, 1);
INSERT INTO `t_sys_relation` VALUES (649, 62, 1);
INSERT INTO `t_sys_relation` VALUES (650, 59, 1);
INSERT INTO `t_sys_relation` VALUES (651, 63, 1);
INSERT INTO `t_sys_relation` VALUES (652, 64, 1);
INSERT INTO `t_sys_relation` VALUES (653, 60, 1);
...
INSERT INTO `t_sys_role` VALUES (3, 1, '2020-03-23 15:09:42', 1, '2020-03-23 15:09:42', 24, '业务', 1, 1, 'worker', NULL);
...
-- ----------------------------
INSERT INTO `t_sys_task` VALUES (1, 1, '2018-12-28 09:54:00', -1, '2020-03-23 15:00:00', 0, '0 0/30 * * * ?', '{\n\"appname\": \"web-flash\",\n\"version\":1\n}\n            \n            \n            \n            \n            \n            \n            \n            \n            \n            \n            \n            ', 0, '2020-03-23 15:00:00', '执行成功', 'cn.enilu.flash.service.task.job.HelloJob', 'default', '测试任务', '测试任务,每30分钟执行一次');
...
CREATE TABLE `t_sys_task_log`  (
  ...
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '定时任务日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_sys_task_log
-- ----------------------------
INSERT INTO `t_sys_task_log` VALUES (1, '2020-03-23 13:30:00', 1, 1, NULL, '测试任务');
INSERT INTO `t_sys_task_log` VALUES (2, '2020-03-23 14:00:00', 1, 1, NULL, '测试任务');
INSERT INTO `t_sys_task_log` VALUES (3, '2020-03-23 14:30:00', 1, 1, NULL, '测试任务');
INSERT INTO `t_sys_task_log` VALUES (4, '2020-03-23 15:00:00', 1, 1, NULL, '测试任务');
...
INSERT INTO `t_sys_user` VALUES (3, 1, '2020-03-23 15:10:15', 1, '2020-03-23 15:10:24', 'worker', NULL, NULL, 1, 'admin', 'worker', '3223eec145a631503459cee7e47c9442', NULL, '3,', 'kc1z1', 1, 1, NULL);
